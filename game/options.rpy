...
define config.name = _("Todoki Todoki Hajime no Voidling Love !")
...
define config.version = "v.0.0.36"
...
define config.save_directory = "Void-1515963801"
